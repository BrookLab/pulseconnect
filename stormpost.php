<?php
/**
 * StormPost API PHP Library
 *
 * @category   Stormpost
 * @package    Stormpost_API
 * @copyright  Copyright (c) 2012 Joshua McGinnis (http://joshuamcginnis.com)
 * @license    TBD
 */

/**
 * Provides an interface to the Stormpost SOAP API with debugging tools
 *
 * @category   Stormpost
 * @package    Stormpost_API
 * @copyright  Copyright (c) 2012 Joshua McGinnis (http://joshuamcginnis.com)
...
class Stormpost_API {
    ...
    protected $_username = 'script.administrator@justmilitaryloans.com';
    protected $_password = 'lz^6XhM1Rv!Q6wx';
